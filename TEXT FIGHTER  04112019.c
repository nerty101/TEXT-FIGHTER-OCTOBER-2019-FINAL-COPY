...
if ((new6 < 1) && (ctr > 4))/// && (posbon < 1) && (posmag < 1))
{
diceQ = (rand() % 4) + 1;
if (diceQ == 1)
...
if (diceQ == 2)
printf("     A very skillful strategy!\n");
if (diceQ == 3)
...
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
printf("     That was a formidable strategy!\n");
if (diceQ == 2)
...
if (diceQ == 1)
printf("     That's a nice move!\n");
if (diceQ == 2)
printf("     Fantastic moves!\n");
if (diceQ == 3)
printf("     A sharp manoeuvre!\n");
if (diceQ == 4)
...
{
{
dice5 = (rand() % 28 + (diflev + cpusp));// 14 then was 17 THEN 18 then 19 NOW 20 OR 21??? 22 23 24 26 27 28 29 -1 28
...
if ((new6 > 0) && (ctr < 5) && (cpusp > 1))
printf("\n     That's excellent Text Fighting!\n\n");
break;
}
...
printf("\n     CPU executes HYPER SUPER ATTACK!\n");
printf("     Player HP at %d\n", playerhp);
Sleep (500);
...
if (diceQ == 3)
printf("     AND A STUNNING CPU VICTORY!\n\n");
}
spatt = 0;
hypsp = 0;
enspcomb2 = 0;
...
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
printf("     IT WAS A SPECTACULAR VICTORY!\n\n");
if (diceQ == 2)
...
if (diceQ == 2)
printf("     A NICE MAGIC SPECIAL COMBO!\n");
if (diceQ == 3)
printf("     A MEAN MAGIC SPECIAL COMBO!\n");
emgspcom5 = 0;
if (playerhp < 1)
{
diceQ = (rand() % 3) + 1;
